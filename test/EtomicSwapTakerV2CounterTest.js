...
describe("EtomicSwapTakerV2Counter", function () {
    beforeEach(async function () {
        accounts = await ethers.getSigners();

        EtomicSwapTakerV2Counter = await ethers.getContractFactory(
            "EtomicSwapTakerV2Counter"
        );
        etomicSwapTakerV2 = await EtomicSwapTakerV2Counter.deploy(dexFeeAddr);
    ...
    it("should allow maker to spend ETH taker payment", async function () {
        ...
        const spendTx = await etomicSwapTakerV2
            .connect(accounts[1])
            .spendTakerPayment(...spendParams, { gasPrice }).should.be.fulfilled;
