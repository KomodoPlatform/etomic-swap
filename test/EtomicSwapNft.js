...
describe("etomicSwapNft", function() {
    ...
    it('should allow maker to send ETH payment', async function() {
        ...
        await etomicSwapNft.connect(accounts[0]).ethMakerPayment(...params, {
    ...
    it('should allow taker to spend ETH maker payment', async function() {
        ...
        const makerSwapRunner = etomicSwapNft.connect(accounts[0]);
        ...
        await etomicSwapNft.connect(accounts[2]).spendMakerPayment(...spendParams).should.be.rejectedWith(INVALID_HASH);
    ...
    it('should allow maker to spend ETH taker payment', async function() {
        ...
        // Make the ETH payment
        await etomicSwapNft.connect(accounts[0]).ethTakerPayment(...payment_params, {
            value: ethers.parseEther('1')
        }).should.be.fulfilled;
    ...
    it('should allow maker to spend ERC20 taker payment', async function() {
        ...
        // Make the ERC20 payment
        await token.approve(etomicSwapNft.target, ethers.parseEther('1'));
        await etomicSwapNft.connect(accounts[0]).erc20TakerPayment(...payment_params).should.be.fulfilled;
