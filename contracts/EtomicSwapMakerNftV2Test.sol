...
contract EtomicSwapMakerNftV2Test is ERC165, IERC1155Receiver, IERC721Receiver {
    ...
    function recoverERC721(address tokenAddress, uint256 tokenId, address to) external {
        IERC721 token = IERC721(tokenAddress);
        token.safeTransferFrom(address(this), to, tokenId);
    }

    function recoverERC1155(address tokenAddress, uint256 tokenId, uint256 amount, address to) external {
        IERC1155 token = IERC1155(tokenAddress);
